...
module.exports = async ctx => {
    ...
    /* 校验, 生成返回值文本 */
    let searchRet = await model.leanCloud.read.searchByUrl(pageUrl);
    let responseContent = '';
    ...
    if(!responseContent) {
        ...
        let pageInformation = await readUtil.grabPageInfo(pageUrl);
        await model.leanCloud.read.store(pageInformation);
    }
