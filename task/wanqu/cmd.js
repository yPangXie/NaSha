...
/* 获取最新一期的内容 */
module.exports.getLatest = function *(ctx) {
    yield util.leanCloud.wanquLog(getIP(ctx));
    /* 先判断DB中是否有缓存 */
...
/* 获取指定某一期 */
module.exports.getSpec = function *(body, ctx) {
...
/* 根据id, 爬去对应页面的数据 */
module.exports.spider = function *(body, ctx) {
